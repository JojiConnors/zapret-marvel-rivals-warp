...
--filter-udp=19294-19344,50000-50100 --dpi-desync=fake --dpi-desync-any-protocol=1 --dpi-desync-fake-discord="%BIN%quic_initial_dbankcloud_ru.bin" --dpi-desync-fake-stun="%BIN%quic_initial_dbankcloud_ru.bin" --dpi-desync-fake-unknown-udp="%BIN%stun.bin" --dpi-desync-repeats=1 --new ^
